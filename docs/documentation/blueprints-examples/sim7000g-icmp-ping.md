...
With 'AT+CIICR' a new PDP session is started. A PDP data session is needed to transfer any sort of data.
...
With 'AT+CIPSHUT' the entire PDP data session of the modem is closed.

# Wrap Up



This guide showed the basic setup of a SIM7000G with a 1NCE SIM to get an ICMP Ping request working.
