...
* The event is triggered on the first interaction of the device with 1NCE OS by interacting with any of endpoints ([UDP](/docs/1nce-os/1nce-os-device-integrator/device-integrator-udp), [COAP](/docs/1nce-os/1nce-os-device-integrator/device-integrator-coap), [LwM2M](/docs/1nce-os/1nce-os-lwm2m/index) registration), [Device Observability Memfault Plugin](/docs/1nce-os/1nce-os-plugins/1nce-os-plugins-device-observability-memfault) or using the [FOTA management Mender Plugin](/docs/1nce-os/1nce-os-plugins/1nce-os-plugins-fota-management-mender) with a particular device.
