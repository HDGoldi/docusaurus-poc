...
* Cell tower "Plus" location mode provides a metadata parameter with accuracy data for resolved locations and tower metadata for unresolved [locations](/1nce-os/1nce-os-device-locator/device-locator-api#get-device-activity).

### Geofencing

* Using Geofencing functionality it is possible to set virtual boundaries to detect geofence crossing event and receive a notification about it via the [Cloud integrator](/1nce-os/1nce-os-cloud-integrator/index).
...
* If "Plus" resolver mode is enabled, then [Device Location credits](/1nce-os/1nce-os-device-locator/index#device-location-credits) will be consumed.
