...
<img src="/img/1nce-os/1nce-os-plugins/1nce-os-plugins-data-visualization-datacake/273a0a1-datacake.png" alt="1NCE in Datacake" width="60%" />
</div>

<div style={{textAlign: 'center'}}>
<img src="/img/1nce-os/1nce-os-plugins/1nce-os-plugins-data-visualization-datacake/668208b-Datacake_worskpace_id.png" alt="Workspace ID in Datacake" width="60%" />
</div>
...
<div style={{textAlign: 'center'}}>
<img src="/img/1nce-os/1nce-os-plugins/1nce-os-plugins-data-visualization-datacake/63a764e-datacake_plugin.png" alt="Datacake Plugin" width="35%" />
</div>

To install a Datacake Plugin you should provide the Workspace Id from Datacake.

<div style={{textAlign: 'center'}}>
<img src="/img/1nce-os/1nce-os-plugins/1nce-os-plugins-data-visualization-datacake/2376da8-datacake_plugin_configuration.png" alt="Datacake plugin installation" width="70%" />
</div>
...
<div style={{textAlign: 'center'}}>
<img src="/img/1nce-os/1nce-os-plugins/1nce-os-plugins-data-visualization-datacake/001d721-datacake_data_fleet.png" alt="Device fleet in Datacake" width="85%" />
</div>

<div style={{textAlign: 'center'}}>
<img src="/img/1nce-os/1nce-os-plugins/1nce-os-plugins-data-visualization-datacake/b442ade-Datacake_dashboards.png" alt="Datacake dashaboard" width="70%" />
</div>
