...
Setting can be enabled in 1NCE portal [Device integrator](/docs/1nce-os/1nce-os-device-integrator/).
...
The actions are processed by an asynchronous API. To receive the results of your actions (read & observe), you can use the [Device Inspector](/docs/1nce-os/1nce-os-device-inspector/). If your requests fail, you can see the messages in the [Admin Logs](/docs/1nce-os/1nce-os-admin-logs/). Messages are forwarded to your cloud integrations as well when they are configured. For more information about the Action API visit the [Device Controller](/docs/1nce-os/1nce-os-device-controller/).
