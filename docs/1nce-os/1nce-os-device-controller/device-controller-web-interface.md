...
<Image align="center" alt="Device controller devices table with filtering" border={false} caption="Device controller devices table with filtering" title="Device controller devices table with filtering" src="https://files.readme.io/d971d2d-Devices_Table__Filtering.png" width="80%" />
...
<Image align="center" alt="Device controler UDP request creation view" border={false} caption="Device controller UDP request creation view" title="Device controler UDP request creation view" src="https://files.readme.io/67230ea-New_Request_UDP.png" width="80%" />
...
<Image align="center" border={false} width="30%" src="https://files.readme.io/66672d9-Not_registered_to_lwm2m_server.png" title="Device not registered to LwM2M server" />

For CoAP and LwM2M messages wizard will wait for the response and display the response details.

<Image align="center" alt="Device controler waiting for response" border={false} caption="Device controller waiting for response" title="Device controler waiting for response" src="https://files.readme.io/c689032-CoAP_waiting_for_Response.png" width="80%" />

<Image align="center" alt="LwM2M Response Details" border={false} caption="LwM2M Response Details" title="LwM2M Response Details" src="https://files.readme.io/2826e7e9939e484a906017f570efa367bd903ffdd06d589beb9c25b93ea52af8-LwM2M_Success_Response.png" width="80%" />
...
<Image align="center" alt="Send attempts configuration" border={false} caption="Send attempts configuration" title="Send attempts configuration" src="https://files.readme.io/f950b70-Send_Attempts.png" width="80%" />
...
<Image align="center" alt="Device controller requests table with filtering" border={false} caption="Device controller requests table with filtering" title="Device controller requests table with filtering" src="https://files.readme.io/5a7af1e454c28b4a6ae7d7cc4b2f0a05272e4315daa06359ab5f2ed76ab08b4d-image.png" width="80%" />
...
<Image align="center" alt="Request details" border={false} caption="Request details" title="Request details" src="https://files.readme.io/7fad4e075b6faab3c2b33f0d14f6e9cee5c5ee77edfc6976e38f2b2fe2f3a8a3-image.png" width="80%" />

### Canceling a request

It is possible to cancel a request form Request Details. This is possible only for "Scheduled" requests.

<Image align="center" alt="Canceling a request" border={false} caption="Canceling a request" title="Canceling a request" src="https://files.readme.io/6c86d47cf86f03314f42048918c5e115c790e218938a4a2178f9969fa4039552-image.png" width="80%" />
